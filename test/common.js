...
export function mockReq(scope) {
  scope
    ...
    .reply(200, data.customCollection.res.get2)
    .get('/admin/products.json?collection_id=841564295')
    .reply(200, data.product.res.list2)
    .get('/admin/products.json?collection_id=395646240')
    .reply(200, data.product.res.list3)
}